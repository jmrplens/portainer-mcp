...
var redactionGuards = []struct {
	...
	{funcName: "redactStackAssociate", operationID: "StackAssociate", fn: redactStackAssociate, handler: stackAssociate},
	{funcName: "redactStackCreateDockerStandaloneRepository", operationID: "StackCreateDockerStandaloneRepository", fn: redactStackCreateDockerStandaloneRepository, handler: stackCreateDockerStandaloneRepository},
	{funcName: "redactStackCreateDockerStandaloneString", operationID: "StackCreateDockerStandaloneString", fn: redactStackCreateDockerStandaloneString, handler: stackCreateDockerStandaloneString},
	{funcName: "redactStackCreateDockerSwarmRepository", operationID: "StackCreateDockerSwarmRepository", fn: redactStackCreateDockerSwarmRepository, handler: stackCreateDockerSwarmRepository},
	{funcName: "redactStackCreateDockerSwarmString", operationID: "StackCreateDockerSwarmString", fn: redactStackCreateDockerSwarmString, handler: stackCreateDockerSwarmString},
	{funcName: "redactStackGitRedeploy", operationID: "StackGitRedeploy", fn: redactStackGitRedeploy, handler: stackGitRedeploy},
	{funcName: "redactStackInspect", operationID: "StackInspect", fn: redactStackInspect, handler: stackInspect},
	{funcName: "redactStackList", operationID: "StackList", fn: redactStackList, handler: stackList},
	{funcName: "redactStackStart", operationID: "StackStart", fn: redactStackStart, handler: stackStart},
	{funcName: "redactStackStop", operationID: "StackStop", fn: redactStackStop, handler: stackStop},
	{funcName: "redactStackUpdate", operationID: "StackUpdate", fn: redactStackUpdate, handler: stackUpdate},
	{funcName: "redactStackUpdateGit", operationID: "StackUpdateGit", fn: redactStackUpdateGit, handler: stackUpdateGit},
}
